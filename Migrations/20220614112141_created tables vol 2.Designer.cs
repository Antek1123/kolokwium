...
namespace kolokwium.Migrations
{
    ...
    [Migration("20220614112141_created tables vol 2")]
    partial class createdtablesvol2
    {
            ...
            modelBuilder.Entity("kolokwium.Models.Album", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AlbumName = "alhija0",
                            IdMusicLabel = 1,
                            PublishDate = new DateTime(2022, 6, 14, 13, 21, 40, 822, DateTimeKind.Local).AddTicks(5318)
                        },
                        new
                        {
                            IdAlbum = 2,
                            AlbumName = "akjrepgiE",
                            IdMusicLabel = 2,
                            PublishDate = new DateTime(2022, 6, 14, 13, 21, 40, 824, DateTimeKind.Local).AddTicks(9678)
                        });
                });
