    ...
    public partial class createdtables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "slawek", "toronto", "gruby" },
                    { 2, "tomek", "monako", "chudy" }
                });

            migrationBuilder.InsertData(
                table: "Album",
                columns: new[] { "IdAlbum", "AlbumName", "IdMusicLabel", "PublishDate" },
                values: new object[] { 1, "alhija0", 1, new DateTime(2022, 6, 14, 12, 49, 56, 454, DateTimeKind.Local).AddTicks(4970) });

            migrationBuilder.InsertData(
                table: "Album",
                columns: new[] { "IdAlbum", "AlbumName", "IdMusicLabel", "PublishDate" },
                values: new object[] { 2, "akjrepgiE", 2, new DateTime(2022, 6, 14, 12, 49, 56, 457, DateTimeKind.Local).AddTicks(4055) });

            migrationBuilder.InsertData(
                table: "Track",
                columns: new[] { "IdTrack", "Duration", "IdMusicAlbum", "TrackName" },
                values: new object[] { 1, 1.43f, 1, "lala" });

            migrationBuilder.InsertData(
                table: "Track",
                columns: new[] { "IdTrack", "Duration", "IdMusicAlbum", "TrackName" },
                values: new object[] { 2, 1.23f, 2, "lulu" });
